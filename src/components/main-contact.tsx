...
const MainContact: React.FC<Props> = ({ items }) => {
  return (
    <div className="grid justify-center gap-4 md:max-w-[64rem] grid-cols-2 sm:grid-cols-3">
      {items?.map(item => {
          ...
          >
            <HoverCard>
              <HoverCardTrigger href={item.href}>
                <div className="flex flex-col items-center justify-center rounded-md p-4 md:p-6">
