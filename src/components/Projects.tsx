...
const Projects: React.FC = () => {
  return (
    <div className="mt-5 grid grid-cols-1 md:grid-cols-2 gap-6 ">
      ...
      <Project id={"diversity-hotline"} title={"Diversity Hotline"} desc={"Hotline for individuals to discuss topics regarding diversity, equity, inclusion, and discrimination"} />
    </div>
  )
}
